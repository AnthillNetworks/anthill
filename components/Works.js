  ...
  return (
    <div className={Styles.maincontainer}>
        <div className={Styles.workcontainer}> 
            <div className={`w-full flex flex-col ${Styles.workcontainer1}`}>
                <div><Image alt='Img3' src="/assets/img3.svg" width={100} height={100} className={Styles.img3}/></div>
            ...
            <div className={`flex flex-col ${Styles.workcontainer2}`}>
                <div><Image alt='Img4' src="/assets/img4.svg" width={100} height={100} className={Styles.img4}/></div>
            </div>
        </div>
        <div className={Styles.workcontainer}> 
