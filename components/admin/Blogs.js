...
function Blogs() {
  ...
  return (
    <main className="blogs flex flex-col py-6 px-8 max-md:ml-0 max-md:w-full" style={{textTransform:"initial"}}>
      <div className="flex flex-col w-full max-md:mt-10 max-md:max-w-full">
        <div className="flex flex-col gap-8 w-full max-md:mr-2.5 max-md:max-w-full">
          <div className='w-full flex items-center justify-between'>
            ...
            <div className="bg-blue-500 text-white px-4 py-2 rounded-lg cursor-pointer" onClick={() => setIsModalOpen(true)}>
              Add Blog
            </div>
          </div>

          <div className="p-6 text-black">
            <div className="flex w-full bg-blue-100 text-black p-4 font-medium text-[16px]">
            ...
            {blogs.map((blog) => (
              <div key={blog.id} className="flex items-center w-full p-4 border-b border-gray-200">
                ...
                <div className="w-1/5 flex justify-center gap-4">
                  <button onClick={() => handleEdit(blog.id)} className="bg-blue-500 text-white px-4 py-2 rounded-lg">
                    Edit
                  </button>
