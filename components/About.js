    ...
    <div className={Styles.lgui}>
      <div className={`${Styles.container} flex justify-end`}>
        <div className={`${Styles.container1} flex flex-col gap-4`}>
          <div>
            <div className={`px-2 ${Styles.about} mt-4 text-6xl`}>WHO WE ARE</div>
            <div className={`${Styles.aboutcon} capitalize`}>At Anthill Networks, we specialize in <span className='bg-[rgba(150,149,150,40%)]'>transforming 
            the ideas of non-tech founders into fully functional SaaS products.</span> From concept to launch, we handle all the technical details so you can focus on your vision</div>
          </div>
        ...
        <div className={`${Styles.container3} flex flex-col gap-4`}>
          ...
          <div>
            ...
            <div className={`${Styles.aboutcon}`}>Our goal is to offer <span className='bg-[rgba(150,149,150,40%)]'> reliable and affordable solutions, making us the perfect alternative to freelancers or high-cost agencies.</span> We don't just build software - we craft the technology that powers your business.</div>
          </div>
        </div>
      </div>
      <div className={` ${Styles.container} ${Styles.mobilecontainer}`}>
        <div className={`${Styles.container1} flex flex-col gap-4`}>
          <div>
            ...
            <div className={`${Styles.aboutcon}`}>At Anthill Networks, we specialize in <span className='bg-[rgba(150,149,150,40%)]'>transforming 
            the ideas of non-tech founders into fully functional SaaS products.</span> From concept to launch, we handle all the technical details so you can focus on your vision</div>
          </div>
          <div className={Styles.Img}>
            <div>
