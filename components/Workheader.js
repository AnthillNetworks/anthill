...
function WorkHeader() {
  return (
    <div className={Styles.mainHeader}>
      <div
        className="px-10 max-md:px-2 border-x-[rgba(215, 214, 214, 1)] w-[90%] px- flex items-center justify-between mx-auto"
        style={{
      ...
      >
        ...
        <a
          ...
          className="px-4 py-2 border border-black cursor-pointer hover:bg-gray-200 transition duration-300 max-md:px-2 max-md:text-[12px] max-md:py-2"
        >
          View Portfolio
        </a>
      </div>
