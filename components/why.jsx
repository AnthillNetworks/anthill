...
const InfoCard = ({ imageSrc, title, description }) => (
  <div className="flex items-start text-start gap-8 p-4 w-[50%] justify-between max-lg:w-[100%]">
    <div className="min-w-[7em] min-h-[7em] mb-4 flex items-center justify-center">
      <img src={imageSrc} alt={title} className=" object-contain" />
    </div>
    <div>
        <h3 className="text-xl font-bold mb-2 font-league-gothic uppercase">{title}</h3>
        <p className="text-gray-600 font-unbounded">{description}</p>
    </div>
  </div>
);
  ...
  return (
    ...
    <div className='w-full border border-gray-300'>
          <div className="w-[90%] mx-auto p-4 border border-x-gray-400">
            <h1 className="text-4xl font-bold text-gray-700 mb-2 font-league-gothic uppercase">WHY ANTHILL NETWORKS?</h1>
            <h2 className="text-xl text-gray-600 mb-8 font-unbounded">More Reliable Than Freelancers, More Affordable Than Software Agencies</h2>
