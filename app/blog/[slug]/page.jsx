...
function BlogPage({ params }) {
  ...
  return (
    <div>
      ...
      open &&  
      <div className={`space-y-2 py-4 max-md:block hidden transform transition-all duration-500 ${open ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'}`}>
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Related Blogs */}
          <div className='blogs gap-10 justify-between w-[90%] mx-auto px-24 py-10 max-md:px-4 overflow-scroll' style={{ borderTop: "1px solid rgba(215, 214, 214, 1)", borderRight: "1px solid rgba(215, 214, 214, 1)", borderLeft: "1px solid rgba(215, 214, 214, 1)" }}>
            <div className='py-10 text-[#7f7e7f] font-medium text-[35px] max-md:text-[20px] max-md:py-4'>YOU MAY ALSO LIKE</div>
